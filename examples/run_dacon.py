...
def json_to_csv():
    ...
    for f in range(1600):
        ...
        y[f][39:41] = x[f][20:22]
        #20(spine2) = 11/4 + 12 / 4 + 17 /2
        y[f][41] = (x[f][22] + x[f][24])/4 + x[f][34]/2
        y[f][42] = (x[f][23] + x[f][25])/4 + x[f][35]/2
        #21(spine1) = 11/3 + 12/3 + 17/3
        y[f][43] = x[f][22]/4 + x[f][24]/4 + x[f][34]/2
        y[f][44] = x[f][23]/4 + x[f][25]/4 + x[f][35]/2
        #22(L instep) = (20+24)/2
